...
function NightBackground() {
  return (
    <>
      {/* Base sky gradient */}
      <div className="pointer-events-none fixed inset-0 z-0 bg-gradient-to-b from-[#070214] via-[#12062a] to-[#1b1250]" />

      {/* Soft glow around the content */}
      <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_50%_45%,rgba(99,102,241,0.18),transparent_45%),radial-gradient(circle_at_50%_60%,rgba(56,189,248,0.10),transparent_55%)]" />
      ...
      {/* Pixel crescent moon (anchored to viewport) */}
      <div className="pointer-events-none fixed left-[2%] top-[2%] z-0 opacity-90 sm:left-[8%] sm:top-[8%]">
        <div className="pixel-moon origin-top-left scale-60 sm:scale-100" />
      </div>

      {/* Horizon mist */}
      <div className="pointer-events-none fixed inset-x-0 bottom-44 z-0 h-52 bg-gradient-to-t from-indigo-400/10 to-transparent blur-2xl" />

      {/* Mountains */}
      <div
        className="pointer-events-none fixed inset-x-0 bottom-0 z-0 h-72 opacity-70"
        style={{
          clipPath:
      ...
      <div
        className="pointer-events-none fixed inset-x-0 bottom-0 z-0 h-60 opacity-85"
        style={{
          clipPath:
